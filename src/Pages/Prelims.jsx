...
Out of 300 applicants, 73 teachers with proficiency training needs were shortlisted for the course. The training was run online by IH in two sessions of 90 minutes every week for ten weeks.`,
    ...
    assistance: `In view of their enthusiasm, the teachers were given a small financial assistance towards internet charges by British Council.`,
    ...
    return (
        <>
            ...
            <div className="px-4 py-10 md:px-8 lg:px-16 max-w-screen-xl mx-auto text-gray-700">
                ...
                <div className="w-full bg-gray-50 py-5 text-gray-800">
                    <div className="max-w-screen-xl mx-auto">
                        <p className="text-base md:text-lg font-medium leading-relaxed">{assistance}</p>
                    </div>
                </div>

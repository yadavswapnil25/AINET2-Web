...
export default function MembershipFormforInstitutionalLongTerm() {
  ...
  const { plan: planPrice, promo, loading: pricingLoading } = usePlanPrice("Institutional", "LongTerm");
  ...
  const validateForm = () => {
    const requiredFields = [
      ...
      'state', 'district', 'contact_person_name', 'mobileperson',
    ...
    <>
      ...
      <div className="max-w-5xl mx-auto my-10 p-4 border border-blue-500 rounded-lg bg-white shadow-md">
        <div className="relative mb-4 pb-2">
          <h1 className="text-4xl font-bold py-4 text-center">Membership Form for Institutional LongTerm</h1>
